...
def usage(exit=False):
    """
    describes the et-sample-raster.py procedure in case of incorrect parameter calls

    syntax: usage()
    """
    print(
        """
$ et-sample-raster.py -training training_raster -predictors
...
def main():
    """
    the main program for et-sample-raster.py
    ...
    # report starting
    print("[ STATUS ]: Starting et-sample-raster.py")
