...
c.InteractiveShellApp.exec_lines = ["%matplotlib tk", "import numpy as np", "import matplotlib.pyplot as plt"]
...
c.InteractiveShell.banner1 = "welcome to the earthtools ipython shell!"
